...
# 加载数据集
train_dataset = datasets.ImageFolder('/home/lzh/hair/hair_2025/dataset/sam_2025_85_rgb_720_newname', transform=transform)
test_dataset = datasets.ImageFolder('/home/lzh/hair/hair_2025/dataset/sam_2025_15_100_rgb', transform=transform)
...
log_file_path = os.path.join(results_path, 'tuningall_720_last_epoch_150_5-10-5_32.txt')
...
# 保存最后一个 epoch 的模型
torch.save(model.state_dict(), os.path.join(results_path, 'tuningall_720_last_epoch_150_5-10-5_32.pth'))
